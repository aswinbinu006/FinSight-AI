...
<button className="px-6 py-3 text-sm font-bold uppercase tracking-widest text-on-surface-variant hover:text-on-surface transition-all">Monthly Wastage</button>
<button className="px-6 py-3 text-sm font-bold uppercase tracking-widest tab-active transition-all">Yearly Wastage</button>
</div>
...
<span className="text-[10px] uppercase tracking-widest font-bold">Yearly Leakage Report</span>
</div>
<h3 className="text-4xl font-bold tracking-tight mb-3">You are wasting ₹14,400/year</h3>
<p className="text-primary-fixed/80 text-sm font-medium max-w-md">Monthly subscriptions are converted to yearly for a long-term perspective on capital leakage.</p>
</div>
...
<div className="text-3xl font-bold">₹43,200<span className="text-xs font-normal opacity-60 ml-1">/3yr</span></div>
</div>
</div>
...
<span className="text-[9px] px-1.5 py-0.5 rounded bg-surface-container text-on-surface-variant font-bold uppercase tracking-tighter">Yearly</span>
</div>
...
<p className="font-bold text-on-surface text-sm">₹7,788/year</p>
...
<div className="flex items-center gap-6">
<div className="text-right">
<p className="font-bold text-on-surface text-sm">₹2,148/year</p>
...
<div className="flex items-center gap-6">
<div className="text-right">
<p className="font-bold text-on-surface text-sm">₹9,600/year</p>
...
<div className="flex items-center gap-6">
<div className="text-right">
<p className="font-bold text-on-surface text-sm">₹4,800/year</p>
