...
<div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-on-background text-white text-[10px] font-bold px-3 py-1.5 rounded-lg">$142k</div>
</div>
...
<p className="text-xs text-on-surface-variant/70 mt-2 leading-relaxed">Shift $50k for an extra 1.2% APY in Portfolio B.</p>
</div>
{/*  Visual Asset Map  */}
