...
<span className="text-[0.6875rem] font-medium uppercase tracking-[0.05em] text-on-surface-variant">Step 4 of 5</span>
<span className="text-[0.6875rem] font-medium uppercase tracking-[0.05em] text-primary">80% Complete</span>
</div>
...
<h1 className="text-[2rem] font-semibold tracking-tight text-on-surface leading-tight mb-4">How much do you usually save in a month?</h1>
<p className="text-on-surface-variant body-md leading-relaxed">This helps us project your growth and estimate when you'll reach your financial milestones.</p>
</div>
{/*  Centered White Card  */}
<div className="w-full max-w-xl bg-surface-container-lowest rounded-xl shadow-[0_4px_12px_rgba(15,23,42,0.03),0_2px_4px_rgba(15,23,42,0.02)] p-6 md:p-10">
<div className="space-y-6">
<div className="space-y-2">
<label className="block text-sm font-medium text-on-surface-variant" htmlFor="savings-input">Monthly Savings</label>
<div className="relative group">
<div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-on-surface-variant group-focus-within:text-primary transition-colors">
<span className="font-medium text-lg">₹</span>
</div>
<input className="block w-full pl-10 pr-4 py-4 bg-surface-container-low border-transparent rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent text-lg font-medium placeholder:text-outline/50 transition-all outline-none" id="savings-input" name="savings-input" placeholder="Enter amount (₹)" type="number"/>
</div>
</div>
{/*  AI Intelligence Ray  */}
<div className="flex items-center gap-3 p-4 bg-surface-container-low rounded-lg border-l-2 border-primary-container">
<span className="material-symbols-outlined text-primary-container" data-icon="auto_awesome">auto_awesome</span>
<p className="text-xs text-on-surface-variant leading-relaxed">
<span className="font-semibold text-on-surface">AI Tip:</span> On average, users with your profile aim for a 20% savings rate of their gross monthly income.
                    </p>
</div>
</div>
</div>
